...
| Date | File | Summary |
|------|------|---------|
| 2 Mar | `2026-03-02-summary.md` | Fix Coolify deploy, cleanup 78 records, **security audit** (35 findings), **15 security fixes** (3H/7M/5L), **unit test expansion** (31→100 tests: CPF calculator, utils, payroll API), 244/244 tests passing |
